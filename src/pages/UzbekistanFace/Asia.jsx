    ...
    <div className="bg-white">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 to-indigo-900 text-white">
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Uzbekistan Face: Asia</h1>
            <p className="text-xl">
              Building bridges between Uzbekistan and the Asia through diplomacy, education, and economic cooperation.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-700 mb-4">
                As a representative of Uzbekistan in the Asia, I have worked to strengthen diplomatic, economic, and educational ties between Uzbekistan and countries across North and South Asia. Through various initiatives and partnerships, I have contributed to enhancing mutual understanding and cooperation.
              </p>
              <p className="text-gray-700 mb-4">
...
export default UzbekistanFaceAsia; 